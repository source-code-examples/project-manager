...
const ProjectForm = forwardRef(
  ({ setProjects, editProject, setEditProject, handleUpdate }, ref) => {
    ...
    // Expose the scrollToForm method to the outside
    ...
    useEffect(() => {
      if (editProject) {
        ...
        // Scroll to form when project data is loaded
        setTimeout(() => {
          if (formRef.current) {
            formRef.current.scrollIntoView({
              behavior: "smooth",
    ...
    return (
      <header className="app_header" ref={formRef}>
